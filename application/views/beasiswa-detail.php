          ...
          <div class="col-lg-12">
            <div class="ud-banner-genbi-content">
              ...
              <ol class="banner-link">
                ...
                <li class="banner-link-nav">
                  <a class="nav-satu" href="">beasiswa</a>
                </li>
                <li class="banner-link-nav">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="org-container">
          ...
          <div class="org-item">
            <i class="lni lni-download"></i>
            <a href="assets/download/50 PENERIMA T 1 2023 V0.2 (1).xlsx" onclick="return confirmDownload('Universitas Majalengka')">
              Universitas Majalengka
            </a>
          </div>
          <div class="org-item">
            <i class="lni lni-download"></i>
            <a href="assets/download/50 PENERIMA T 1 2023 V0.2 (1).xlsx" onclick="return confirmDownload('Universitas Kuningan')">
              Univerisitas Kuningan </a>
          </div>
          <div class="org-item ini-youtuber ">
            <i class="lni lni-download"></i>
            <a href="assets/download/50 PENERIMA T 1 2023 V0.2 (1).xlsx" onclick="return confirmDownload('Universitas Wiralodra')">
