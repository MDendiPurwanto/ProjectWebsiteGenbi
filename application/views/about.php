...
<head>
  ...
  <!-- ===== All CSS files ===== -->
  <!-- Menggunakan base_url() untuk merujuk ke file CSS -->
        ...
        <div class="row g-0 align-items-center justify-content-center">
          <div class="col-lg-4 col-md-6 col-sm-10">
            <div
              ...
              <div class="ud-tujuan-body">
               <p class="desc-tujuan">
                menciptakan generasi muda yang <br> tangguh serta menjadi ujung tombak  atau garda terdepan
               </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-10">
            ...
            <span class="ud-popular-tag"><i class="lni lni-network"></i></span>
              ...
              <div class="ud-tujuan-body">
                <p>mengembangkan generasi muda yang memiliki kepemimpinan yang kuat dan <br>etika yang baik</p>
              </div>
            </div>
          </div>
        </div>
